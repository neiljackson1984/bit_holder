        ...
        features.FosAhS5AHTnwn4r_1 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var xwYsWQKVdlepPG_query;
                    xwYsWQKVdlepPG_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS4$FACESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S5.7$RightplaneOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Plane 1" }
                    cPlane(context, id + "FosAhS5AHTnwn4r_1", { "entities" : qUnion([xwYsWQKVdlepPG_query]), "cplaneType" : CPlaneType.OFFSET, "offset" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "angle" : { 'value' : try(0 * degree), 'expression' : "0 deg" }.value, "oppositeDirection" : false, "flipAlignment" : false, "width" : { 'value' : try(150 * millimeter), 'expression' : "150 mm" }.value, "height" : { 'value' : try(150 * millimeter), 'expression' : "150 mm" }.value, "asVersion" : FeatureScriptVersionNumber.V1324_FLIP_NORMAL });
                }
            };
