        ...
        features.Fe3kgTkIQcUex9Y_0 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    e9f05a85f95bf68be1c454008::m3fe83b491664242c37fd48a9::bitHolder_feature(context, id + "Fe3kgTkIQcUex9Y_0", { "nameOfSelectedCannedDesign" : "1/4-inch hex shank driver bits holder", "cannedDesignChoices" : [{ "name" : "1/4-inch drive, imperial sockets holder", "displayName" : "( )  1/4-inch drive, imperial sockets holder", "selected" : false }, { "name" : "1/4-inch drive, metric sockets holder", "displayName" : "( )  1/4-inch drive, metric sockets holder", "selected" : false }, { "name" : "1/4-inch hex shank drill bits holder", "displayName" : "( )  1/4-inch hex shank drill bits holder", "selected" : false }, { "name" : "1/4-inch hex shank driver bits holder", "displayName" : "(*)  1/4-inch hex shank driver bits holder", "selected" : true }, { "name" : "1/4-inch hex shank long driver bits holder", "displayName" : "( )  1/4-inch hex shank long driver bits holder", "selected" : false }, { "name" : "3/8-inch drive, imperial sockets holder", "displayName" : "( )  3/8-inch drive, imperial sockets holder", "selected" : false }, { "name" : "3/8-inch drive, metric sockets holder", "displayName" : "( )  3/8-inch drive, metric sockets holder", "selected" : false }, { "name" : "bondhus_hex_drivers_holder", "displayName" : "( )  bondhus_hex_drivers_holder", "selected" : false }, { "name" : "defaultBitHolder", "displayName" : "( )  defaultBitHolder", "selected" : false }], "refreshCannedDesignsRequested" : false, "changeCount" : { 'value' : try(29.0), 'expression' : "29.0" }.value });
                }
            };
